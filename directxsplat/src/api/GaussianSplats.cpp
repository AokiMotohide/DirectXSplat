...
std::shared_ptr<GaussianSplats::Impl>& GaussianSplatsAccess::ImplOf(GaussianSplats& splats) {
  return splats.impl_;
}

const std::shared_ptr<GaussianSplats::Impl>& GaussianSplatsAccess::ImplOf(const GaussianSplats& splats) {
  return splats.impl_;
}

GaussianSplats GaussianSplatsAccess::Make(std::shared_ptr<GaussianSplats::Impl> impl) {
  return GaussianSplats(std::move(impl));
}

GaussianSplats GaussianSplatsAccess::Make(Scene scene) {
  return GaussianSplats(std::make_shared<GaussianSplats::Impl>(std::move(scene)));
}

std::shared_ptr<GaussianSplats::Impl>& GaussianSplatsAccess::EnsureImpl(GaussianSplats& splats) {
